...
CreateThread(function()
    ...
    while true do
        Wait(Menu.isChangeFPSChecked and 500 or 250) -- bylo 50 ms - HUD nie potrzebuje 20 odswiezen na sekunde
...
CreateThread(function()
    ...
    local heading
	while true do
        Wait(Menu.isChangeCompassFPSChecked and 100 or 50) -- bylo Wait(0)
        local show = true
        local player = PlayerPedId()
