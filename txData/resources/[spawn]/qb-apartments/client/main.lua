...
RegisterNetEvent('apartments:client:setupSpawnUI', function(cData, isNewCharacter)
    QBCore.Functions.TriggerCallback('apartments:GetOwnedApartment', function(result)
        if isNewCharacter and Apartments.Starting and not result then
        ...
        TriggerEvent('qb-spawn:client:spawnLastLocation')
        return
    end, cData.citizenid)
end)
