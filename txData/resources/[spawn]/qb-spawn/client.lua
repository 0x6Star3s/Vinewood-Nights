...
RegisterNetEvent('qb-spawn:client:spawnLastLocation', function()
    if Config.AutoLastLocation == false then
...
exports('SpawnAtLastLocation', SpawnAtLastLocation)
