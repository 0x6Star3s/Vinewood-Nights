...
RegisterNetEvent('qb-trucker:server:01101110', function(drops)
    ...
    local maxDrops = Config.TruckerJobMaxDrops or 20
    if not drops or drops < 1 or drops % 1 ~= 0 or drops > maxDrops then return end -- liczba dostaw z sufitu = kasa z sufitu
