...
$(function() {
    ...
    $("#initiateTransfer").click(function() {
        ...
        // numer konta to IBAN gracza (np. US012345678) - nie liczba; sort code jest opcjonalny
        if(amount !== undefined && amount !== null && amount > 0 && account !== undefined && account !== null && account !== '') {
