...
local function RobberyPed()
    if Config.UseTarget then
        ...
        local options = {
            {
                ...
                action = function()
                    ...
                    stealingPed = nil
                    stealData = {}
                    exports['qb-target']:RemoveTargetEntity(targetStealingPed)
                end,
        ...
        exports['qb-target']:AddTargetEntity(targetStealingPed, {options = options, distance = 2.0})
            ...
            if getRobbed <= Config.RobberyChance then
                ...
                if pedDist2 < 1.5 and cornerselling then
                    if Config.UseTarget and not zoneMade then
                        ...
                        local options = {
                            {
                                ...
                                action = function()
                                    ...
                                    ClearPedTasksImmediately(ped)
                                    lastPed[#lastPed + 1] = ped
                                    exports['qb-target']:RemoveTargetEntity(targetPedSale)
                                    PoliceCall()
                                end,
                            },
                            {
                        ...
                        exports['qb-target']:AddTargetEntity(targetPedSale, {options = options, distance = 2.0})
    ...
    if not cornerselling then
        ...
        CreateThread(function()
            while cornerselling do
                ...
                Wait(500) -- bylo Wait(0): skan wszystkich pedow co klatke
            end
        end)
    else
        stealingPed = nil
