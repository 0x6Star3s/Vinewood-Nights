...
function processVehicleHandling(pCurrentVehicle)
  -- klucz = tablica, nie uchwyt encji: po /dv gra oddaje ten sam numer uchwytu nowemu autu,
  -- wiec nowy pojazd dziedziczyl zapamietane wartosci (skret, hamulce, trakcja) po zupelnie innym,
  -- np. po motocyklu. Stara sciezka zapasowa wolala nieistniejace GetVehiclePlate().
  local vehicleIdentifier = GetVehicleNumberPlateText(pCurrentVehicle)
