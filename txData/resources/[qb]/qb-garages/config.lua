...
-- Panel administracyjny garaży (NUI) - pozwala adminom konfigurować w grze
-- miejsce spawnu pojazdu, miejsce interakcji/blipa (mapa), miejsce odstawienia
-- auta oraz miejsce 3D podglądu pojazdu, bez edycji tego pliku i restartu configu.
Config.AdminPanel = {
    command = "garageadmin",     -- komenda otwierająca panel (tylko dla adminów)
...
Config.GarageMarkers = {
    type = 1,
    scale = vector3(1.3, 1.3, 0.35),
    putScale = vector3(2.6, 2.6, 0.7),
    putInteractDistance = 6.0,
    zOffset = -0.9,
    takeColor = { r = 0, g = 140, b = 255, a = 170 },
    putColor = { r = 0, g = 140, b = 255, a = 120 },
    depotColor = { r = 0, g = 140, b = 255, a = 190 }
}
