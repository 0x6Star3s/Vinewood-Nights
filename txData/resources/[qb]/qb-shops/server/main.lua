...
---Produkty sklepu prosto z Configu - qb-inventory bierze stad cene, zeby nie ufac klientowi
---(audyt ekonomii 2026-09-02, pkt 2)
---@param shopName string klucz z Config.Locations, np. "247supermarket"
---@return table|nil
exports('GetShopProducts', function(shopName)
    local shop = Config.Locations[shopName]
    return shop and shop.products or nil
end)
