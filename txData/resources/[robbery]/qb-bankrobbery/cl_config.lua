...
-- Minimalna liczba policjantow na sluzbie (audyt ekonomii: bylo 0 = bank bez ryzyka).
-- Serwer sprawdza to jeszcze raz po swojej stronie wg QBConfig.Economy.Heists w qb-core/config.lua.
