...
-- Dumping database structure for projectterrific
CREATE DATABASE IF NOT EXISTS `projectterrific` /*!40100 DEFAULT CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci */;
USE `projectterrific`;

-- Dumping structure for table projectterrific.apartments
...
-- Dumping data for table projectterrific.apartments: ~0 rows (approximately)

-- Dumping structure for table projectterrific.bank_accounts
...
-- Dumping data for table projectterrific.bank_accounts: ~0 rows (approximately)

-- Dumping structure for table projectterrific.bank_accounts_new
...
-- Dumping data for table projectterrific.bank_accounts_new: ~11 rows (approximately)
...
-- Dumping structure for table projectterrific.bank_cards
...
-- Dumping data for table projectterrific.bank_cards: ~0 rows (approximately)

-- Dumping structure for table projectterrific.bank_statements
...
-- Dumping data for table projectterrific.bank_statements: ~0 rows (approximately)

-- Dumping structure for table projectterrific.bans
...
-- Dumping data for table projectterrific.bans: ~0 rows (approximately)

-- Dumping structure for table projectterrific.crypto
...
-- Dumping data for table projectterrific.crypto: ~1 rows (approximately)
...
-- Dumping structure for table projectterrific.crypto_transactions
...
-- Dumping data for table projectterrific.crypto_transactions: ~0 rows (approximately)

-- Dumping structure for table projectterrific.dealers
...
-- Dumping data for table projectterrific.dealers: ~0 rows (approximately)

-- Dumping structure for table projectterrific.dpkeybinds
...
-- Dumping data for table projectterrific.dpkeybinds: ~0 rows (approximately)

-- Dumping structure for table projectterrific.fuel_stations
...
-- Dumping data for table projectterrific.fuel_stations: ~27 rows (approximately)
...
-- Dumping structure for table projectterrific.gloveboxitems
...
-- Dumping data for table projectterrific.gloveboxitems: ~0 rows (approximately)

-- Dumping structure for table projectterrific.houselocations
...
-- Dumping data for table projectterrific.houselocations: ~1 rows (approximately)
...
-- Dumping structure for table projectterrific.house_plants
...
-- Dumping data for table projectterrific.house_plants: ~0 rows (approximately)

-- Dumping structure for table projectterrific.lapraces
...
-- Dumping data for table projectterrific.lapraces: ~0 rows (approximately)

-- Dumping structure for table projectterrific.management_funds
...
-- Dumping data for table projectterrific.management_funds: ~12 rows (approximately)
...
-- Dumping structure for table projectterrific.management_outfits
...
-- Dumping data for table projectterrific.management_outfits: ~0 rows (approximately)

-- Dumping structure for table projectterrific.mdt_bolos
...
-- Dumping data for table projectterrific.mdt_bolos: ~0 rows (approximately)

-- Dumping structure for table projectterrific.mdt_bulletin
...
-- Dumping data for table projectterrific.mdt_bulletin: ~0 rows (approximately)

-- Dumping structure for table projectterrific.mdt_clocking
...
-- Dumping data for table projectterrific.mdt_clocking: ~0 rows (approximately)

-- Dumping structure for table projectterrific.mdt_convictions
...
-- Dumping data for table projectterrific.mdt_convictions: ~0 rows (approximately)

-- Dumping structure for table projectterrific.mdt_data
...
-- Dumping data for table projectterrific.mdt_data: ~0 rows (approximately)

-- Dumping structure for table projectterrific.mdt_impound
...
-- Dumping data for table projectterrific.mdt_impound: ~0 rows (approximately)

-- Dumping structure for table projectterrific.mdt_incidents
...
-- Dumping data for table projectterrific.mdt_incidents: ~0 rows (approximately)

-- Dumping structure for table projectterrific.mdt_logs
...
-- Dumping data for table projectterrific.mdt_logs: ~0 rows (approximately)

-- Dumping structure for table projectterrific.mdt_reports
...
-- Dumping data for table projectterrific.mdt_reports: ~0 rows (approximately)

-- Dumping structure for table projectterrific.mdt_vehicleinfo
...
-- Dumping data for table projectterrific.mdt_vehicleinfo: ~0 rows (approximately)

-- Dumping structure for table projectterrific.mdt_weaponinfo
...
-- Dumping data for table projectterrific.mdt_weaponinfo: ~0 rows (approximately)

-- Dumping structure for table projectterrific.newspaper
...
-- Dumping data for table projectterrific.newspaper: ~0 rows (approximately)

-- Dumping structure for table projectterrific.occasion_vehicles
...
-- Dumping data for table projectterrific.occasion_vehicles: ~0 rows (approximately)

-- Dumping structure for table projectterrific.ox_doorlock
...
-- Dumping data for table projectterrific.ox_doorlock: ~829 rows (approximately)
...
-- Dumping structure for table projectterrific.paycheck_account
...
-- Dumping data for table projectterrific.paycheck_account: ~0 rows (approximately)

-- Dumping structure for table projectterrific.paycheck_logs
...
-- Dumping data for table projectterrific.paycheck_logs: ~0 rows (approximately)

-- Dumping structure for table projectterrific.phone_chatrooms
...
-- Dumping data for table projectterrific.phone_chatrooms: ~3 rows (approximately)
...
-- Dumping structure for table projectterrific.phone_chatroom_messages
...
-- Dumping data for table projectterrific.phone_chatroom_messages: ~0 rows (approximately)

-- Dumping structure for table projectterrific.phone_gallery
CREATE TABLE IF NOT EXISTS `phone_gallery` (
  ...
  `date` timestamp NULL DEFAULT current_timestamp(),
  PRIMARY KEY (`id`),
  KEY `idx_phone_gallery_citizenid` (`citizenid`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

-- Dumping data for table projectterrific.phone_gallery: ~0 rows (approximately)

-- Dumping structure for table projectterrific.phone_invoices
...
-- Dumping data for table projectterrific.phone_invoices: ~0 rows (approximately)

-- Dumping structure for table projectterrific.phone_messages
...
-- Dumping data for table projectterrific.phone_messages: ~0 rows (approximately)

-- Dumping structure for table projectterrific.phone_note
...
-- Dumping data for table projectterrific.phone_note: ~0 rows (approximately)

-- Dumping structure for table projectterrific.phone_tweets
...
-- Dumping data for table projectterrific.phone_tweets: ~0 rows (approximately)

-- Dumping structure for table projectterrific.players
...
-- Dumping data for table projectterrific.players: ~0 rows (approximately)

-- Dumping structure for table projectterrific.playerskins
...
-- Dumping data for table projectterrific.playerskins: ~0 rows (approximately)

-- Dumping structure for table projectterrific.player_contacts
...
-- Dumping data for table projectterrific.player_contacts: ~0 rows (approximately)

-- Dumping structure for table projectterrific.player_houses
...
-- Dumping data for table projectterrific.player_houses: ~0 rows (approximately)

-- Dumping structure for table projectterrific.player_jobs
...
-- Dumping data for table projectterrific.player_jobs: ~15 rows (approximately)
...
-- Dumping structure for table projectterrific.player_mails
...
-- Dumping data for table projectterrific.player_mails: ~0 rows (approximately)

-- Dumping structure for table projectterrific.player_outfits
...
-- Dumping data for table projectterrific.player_outfits: ~0 rows (approximately)

-- Dumping structure for table projectterrific.player_outfit_codes
...
-- Dumping data for table projectterrific.player_outfit_codes: ~0 rows (approximately)

-- Dumping structure for table projectterrific.player_transactions
...
-- Dumping data for table projectterrific.player_transactions: ~1 rows (approximately)
...
-- Dumping structure for table projectterrific.player_vehicles
...
-- Dumping data for table projectterrific.player_vehicles: ~0 rows (approximately)

-- Dumping structure for table projectterrific.player_warns
...
-- Dumping data for table projectterrific.player_warns: ~0 rows (approximately)

-- Dumping structure for table projectterrific.scenes
...
-- Dumping data for table projectterrific.scenes: ~0 rows (approximately)

-- Dumping structure for table projectterrific.stashitems
...
-- Dumping data for table projectterrific.stashitems: ~0 rows (approximately)

-- Dumping structure for table projectterrific.trunkitems
...
-- Dumping data for table projectterrific.trunkitems: ~0 rows (approximately)

-- Dumping structure for table projectterrific.vaults
...
-- Dumping data for table projectterrific.vaults: ~0 rows (approximately)

-- Dumping structure for table projectterrific.av_restaurants
...
-- Dumping data for table projectterrific.av_restaurants: ~116 rows (approximately)
